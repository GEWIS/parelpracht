...
export class Client {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(VATSummary.fromJS(item));
        } else {
  ...
  protected processGetUserSummaries(response: Response): Promise<UserSummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(UserSummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
   ...
   * @return Ok
   */
  dumpPersonalInformation(id: number): Promise<UserGDPRDumpResponse> {
    let url_ = this.baseUrl + '/user/{id}/dump';
    if (id === undefined || id === null) throw new globalThis.Error("The parameter 'id' must be defined.");
    url_ = url_.replace('{id}', encodeURIComponent('' + id));
    url_ = url_.replace(/[?&]$/, '');
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processDumpPersonalInformation(_response);
    });
  }

  protected processDumpPersonalInformation(response: Response): Promise<UserGDPRDumpResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        let result200: any = null;
        let resultData200 = _responseText === '' ? null : JSON.parse(_responseText, this.jsonParseReviver);
        result200 = UserGDPRDumpResponse.fromJS(resultData200);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
    ...
    return Promise.resolve<UserGDPRDumpResponse>(null as any);
  }
  ...
  protected processGetProductSummaries(response: Response): Promise<ProductSummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(ProductSummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetProductStatistics(response: Response): Promise<AnalysisResultByYear[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(AnalysisResultByYear.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
   ...
   * @return Ok
   */
  getProductFile(id: number, fileId: number): Promise<string> {
    let url_ = this.baseUrl + '/product/{id}/file/{fileId}';
    if (id === undefined || id === null) throw new globalThis.Error("The parameter 'id' must be defined.");
    url_ = url_.replace('{id}', encodeURIComponent('' + id));
    if (fileId === undefined || fileId === null) throw new globalThis.Error("The parameter 'fileId' must be defined.");
  ...
  protected processGetProductFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  getDashboardProductInstanceStatistics(year: number): Promise<DashboardProductInstanceStats> {
    ...
    if (year === undefined || year === null) throw new globalThis.Error("The parameter 'year' must be defined.");
  ...
  protected processGetCategorySummaries(response: Response): Promise<CategorySummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(CategorySummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetInvoiceSummaries(response: Response): Promise<InvoiceSummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(InvoiceSummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetExpiredInvoices(response: Response): Promise<ExpiredInvoice[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(ExpiredInvoice.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  deleteProductFromInvoice(id: number, prodId: number): Promise<void> {
    ...
    if (id === undefined || id === null) throw new globalThis.Error("The parameter 'id' must be defined.");
    url_ = url_.replace('{id}', encodeURIComponent('' + id));
    if (prodId === undefined || prodId === null) throw new globalThis.Error("The parameter 'prodId' must be defined.");
   ...
   * @return Ok
   */
  generateInvoiceFile(id: number, body: GenerateInvoiceParams): Promise<string> {
  ...
  protected processGenerateInvoiceFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return Ok
   */
  getInvoiceFile(id: number, fileId: number): Promise<string> {
  ...
  protected processGetInvoiceFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return Ok
   */
  generateCustomInvoice(body: CustomInvoiceGenSettings): Promise<string> {
  ...
  protected processGenerateCustomInvoice(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processGetContractSummaries(response: Response): Promise<ContractSummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(ContractSummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetRecentContracts(response: Response): Promise<RecentContract[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(RecentContract.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
   ...
   * @return Ok
   */
  updateProductInstanceOnContract(
    id: number,
    prodId: number,
    body: Partial_ProductInstanceParams_,
   ...
   * @return Ok
   */
  addProductInstanceStatusToContract(
    id: number,
    prodId: number,
    body: ProductInstanceStatusParams,
   ...
   * @return Ok
   */
  updateProductInstanceActivityOnContract(
    id: number,
    prodId: number,
    activityId: number,
    body: Partial_ActivityParams_,
  ): Promise<BaseActivity> {
   ...
   * @return Ok
   */
  generateContractFile(id: number, body: GenerateContractParams): Promise<string> {
  ...
  protected processGenerateContractFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return Ok
   */
  getContractFile(id: number, fileId: number): Promise<string> {
  ...
  protected processGetContractFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processGetContactSummaries(response: Response): Promise<ContactSummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(ContactSummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetCompanySummaries(response: Response): Promise<CompanySummary[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(CompanySummary.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
  ...
  protected processGetUnresolvedInvoices(response: Response): Promise<Invoice[]> {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        if (Array.isArray(resultData200)) {
          result200 = [] as any;
          for (let item of resultData200) result200!.push(Invoice.fromJS(item));
        } else {
          result200 = null as any;
        }
        return result200;
   ...
   * @return Ok
   */
  getCompanyFile(id: number, fileId: number): Promise<string> {
  ...
  protected processGetCompanyFile(response: Response): Promise<string> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  uploadContractFile(file: FileParameter, name: string): Promise<ContractFile> {
    ...
    if (file === null || file === undefined) throw new globalThis.Error("The parameter 'file' cannot be null.");
    else content_.append('file', file.data, file.fileName ? file.fileName : 'file');
    if (name === null || name === undefined) throw new globalThis.Error("The parameter 'name' cannot be null.");
...
export class ValueAddedTax implements IValueAddedTax {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.products)) {
      data['products'] = [];
      for (let item of this.products) data['products'].push(item ? item.toJSON() : (undefined as any));
    }
    return data;
  }
}
...
export class Product implements IProduct {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['instances'])) {
        ...
        for (let item of _data['instances']) this.instances!.push(ProductInstance.fromJS(item));
      }
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(ProductActivity.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files']) this.files!.push(ProductFile.fromJS(item));
      }
      this.pricing = _data['pricing'] ? ProductPricing.fromJS(_data['pricing']) : (undefined as any);
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['valueAddedTax'] = this.valueAddedTax ? this.valueAddedTax.toJSON() : (undefined as any);
    data['category'] = this.category ? this.category.toJSON() : (undefined as any);
    if (Array.isArray(this.instances)) {
      data['instances'] = [];
      for (let item of this.instances) data['instances'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.activities)) {
      data['activities'] = [];
      for (let item of this.activities) data['activities'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.files)) {
      data['files'] = [];
      for (let item of this.files) data['files'].push(item ? item.toJSON() : (undefined as any));
    }
...
export class Contract implements IContract {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['products'])) {
        this.products = [] as any;
        for (let item of _data['products']) this.products!.push(ProductInstance.fromJS(item));
      }
      ...
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(ContractActivity.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files']) this.files!.push(ContractFile.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['assignedTo'] = this.assignedTo ? this.assignedTo.toJSON() : (undefined as any);
...
price is excluding VAT */
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(ProductInstanceActivity.fromJS(item));
      }
...
be sent to "email", or "replyToEmail" */
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.identityLocal = _data['identityLocal'] ? IdentityLocal.fromJS(_data['identityLocal']) : (undefined as any);
      this.identityLdap = _data['identityLdap'] ? IdentityLDAP.fromJS(_data['identityLdap']) : (undefined as any);
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.roles)) {
      data['roles'] = [];
      for (let item of this.roles) data['roles'].push(item ? item.toJSON() : (undefined as any));
    }
    data['identityLocal'] = this.identityLocal ? this.identityLocal.toJSON() : (undefined as any);
    data['identityLdap'] = this.identityLdap ? this.identityLdap.toJSON() : (undefined as any);
    return data;
  }
}
...
export class Role implements IRole {
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.users)) {
      data['users'] = [];
      for (let item of this.users) data['users'].push(item ? item.toJSON() : (undefined as any));
    }
    return data;
  }
}
...
export class Company implements ICompany {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['contracts'])) {
        ...
        for (let item of _data['contracts']) this.contracts!.push(Contract.fromJS(item));
      }
      if (Array.isArray(_data['invoices'])) {
        this.invoices = [] as any;
        for (let item of _data['invoices']) this.invoices!.push(Invoice.fromJS(item));
      }
      ...
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(CompanyActivity.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files']) this.files!.push(CompanyFile.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.contracts)) {
      data['contracts'] = [];
      for (let item of this.contracts) data['contracts'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.invoices)) {
      data['invoices'] = [];
      for (let item of this.invoices) data['invoices'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.contacts)) {
      data['contacts'] = [];
      for (let item of this.contacts) data['contacts'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.activities)) {
      data['activities'] = [];
      for (let item of this.activities) data['activities'].push(item ? item.toJSON() : (undefined as any));
...
export class Invoice implements IInvoice {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.createdBy = _data['createdBy'] ? User.fromJS(_data['createdBy']) : new User();
      this.assignedToId = _data['assignedToId'];
      this.assignedTo = _data['assignedTo'] ? User.fromJS(_data['assignedTo']) : (undefined as any);
      this.comments = _data['comments'];
      this.company = _data['company'] ? Company.fromJS(_data['company']) : new Company();
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(InvoiceActivity.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files']) this.files!.push(InvoiceFile.fromJS(item));
      }
    }
  }
...
export class InvoiceActivity implements IInvoiceActivity {
  ...
  subType!: InvoiceStatus | undefined;
...
export class ContractActivity implements IContractActivity {
  ...
  contract!: Contract;
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ContractStatus | undefined;
...
export class ProductInstanceActivity implements IProductInstanceActivity {
  ...
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ProductInstanceStatus | undefined;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.productInstance = _data['productInstance']
        ? ProductInstance.fromJS(_data['productInstance'])
        : new ProductInstance();
      this.subType = _data['subType'];
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['productInstance'] = this.productInstance ? this.productInstance.toJSON() : (undefined as any);
    data['subType'] = this.subType;
    return data;
  }
}
...
export class VATListResponse implements IVATListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(ValueAddedTax.fromJS(item));
      }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.list)) {
      data['list'] = [];
      for (let item of this.list) data['list'].push(item ? item.toJSON() : (undefined as any));
    }
...
export class ListParams implements IListParams {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.sorting = _data['sorting'] ? ListSorting.fromJS(_data['sorting']) : (undefined as any);
      this.search = _data['search'];
      if (Array.isArray(_data['filters'])) {
        this.filters = [] as any;
        for (let item of _data['filters']) this.filters!.push(ListOrFilter.fromJS(item));
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['skip'] = this.skip;
    data['take'] = this.take;
    data['sorting'] = this.sorting ? this.sorting.toJSON() : (undefined as any);
    data['search'] = this.search;
    if (Array.isArray(this.filters)) {
      data['filters'] = [];
      for (let item of this.filters) data['filters'].push(item ? item.toJSON() : (undefined as any));
    }
    return data;
  }
}
...
export class UserListResponse implements IUserListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(User.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export class CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_
  implements ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_
{
  /** Date at which this entity has been created */
  createdAt!: Date;
  /** Date at which this entity has last been updated */
  ...
  constructor(data?: ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
    data = typeof data === 'object' ? data : {};
    let result = new CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export interface ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
  /** Date at which this entity has been created */
  createdAt: Date;
  /** Date at which this entity has last been updated */
  updatedAt: Date;
...
/** From T, pick a set of properties whose keys are in the union K */
export class CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_
  implements ICreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_
{
  /** Label of the file as shown in the front-end */
  name!: string;
  /** Date at which this entity has been created */
  ...
  constructor(data?: ICreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_ {
    data = typeof data === 'object' ? data : {};
    let result = new CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export interface ICreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_ {
  /** Label of the file as shown in the front-end */
  name: string;
  /** Date at which this entity has been created */
  createdAt: Date;
...
/** From T, pick a set of properties whose keys are in the union K */
export class Title_ implements ITitle_ {
  /** Title or name of this contract/collaboration */
  title!: string;

  [key: string]: any;

  constructor(data?: ITitle_) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): Title_ {
    data = typeof data === 'object' ? data : {};
    let result = new Title_();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export class SubType_ implements ISubType_ {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ContractStatus;

  [key: string]: any;

  constructor(data?: ISubType_) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): SubType_ {
    data = typeof data === 'object' ? data : {};
    let result = new SubType_();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export class NameDutchOrNameEnglish_ implements INameDutchOrNameEnglish_ {
  /** Dutch name of the product */
  nameDutch!: string;
  /** English name of the product */
  nameEnglish!: string;
  ...
  constructor(data?: INameDutchOrNameEnglish_) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): NameDutchOrNameEnglish_ {
    data = typeof data === 'object' ? data : {};
    let result = new NameDutchOrNameEnglish_();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export interface INameDutchOrNameEnglish_ {
  /** Dutch name of the product */
  nameDutch: string;
  /** English name of the product */
  nameEnglish: string;
...
/** From T, pick a set of properties whose keys are in the union K */
export class SubType_2 implements ISubType_2 {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ProductInstanceStatus;

  [key: string]: any;

  constructor(data?: ISubType_2) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): SubType_2 {
    data = typeof data === 'object' ? data : {};
    let result = new SubType_2();
    result.init(data);
    return result;
  }
...
export class ProductInstanceGDPRResponse extends NameDutchOrNameEnglish_ implements IProductInstanceGDPRResponse {
  activities!: Activities[];

  [key: string]: any;

  constructor(data?: IProductInstanceGDPRResponse) {
    super(data);
    if (!data) {
      this.activities = [];
    }
  ...
  override init(_data?: any) {
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(item);
      }
    }
  }

  static override fromJS(data: any): ProductInstanceGDPRResponse {
    data = typeof data === 'object' ? data : {};
    let result = new ProductInstanceGDPRResponse();
    result.init(data);
    return result;
  }
  ...
  override toJSON(data?: any) {
    ...
    if (Array.isArray(this.activities)) {
      data['activities'] = [];
      for (let item of this.activities) data['activities'].push(item);
    }
    super.toJSON(data);
    return data;
  }
...
export interface IProductInstanceGDPRResponse extends INameDutchOrNameEnglish_ {
  activities: Activities[];

  [key: string]: any;
}

export class ContractGDPRResponse extends Title_ implements IContractGDPRResponse {
  products!: ProductInstanceGDPRResponse[];
  files!: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  ...
  constructor(data?: IContractGDPRResponse) {
    super(data);
    if (!data) {
      this.products = [];
      this.files = [];
  ...
  override init(_data?: any) {
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['products'])) {
        this.products = [] as any;
        for (let item of _data['products']) this.products!.push(ProductInstanceGDPRResponse.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files'])
          this.files!.push(CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_.fromJS(item));
      }
      if (Array.isArray(_data['activities'])) {
        this.activities = [] as any;
        for (let item of _data['activities']) this.activities!.push(item);
      }
      this.assignedToYou = _data['assignedToYou'];
      this.createdByYou = _data['createdByYou'];
    }
  }

  static override fromJS(data: any): ContractGDPRResponse {
    data = typeof data === 'object' ? data : {};
    let result = new ContractGDPRResponse();
    result.init(data);
    return result;
  }
  ...
  override toJSON(data?: any) {
    ...
    data['assignedToYou'] = this.assignedToYou;
    data['createdByYou'] = this.createdByYou;
    super.toJSON(data);
    return data;
  }
}

export interface IContractGDPRResponse extends ITitle_ {
  products: ProductInstanceGDPRResponse[];
  files: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities: Activities2[];
  assignedToYou: boolean;
...
/** From T, pick a set of properties whose keys are in the union K */
export class Title_2 implements ITitle_2 {
  /** Name of the invoice (by default the same as the first contract) */
  title!: string;

  [key: string]: any;

  constructor(data?: ITitle_2) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): Title_2 {
    data = typeof data === 'object' ? data : {};
    let result = new Title_2();
    result.init(data);
    return result;
  }
...
/** From T, pick a set of properties whose keys are in the union K */
export class SubType_3 implements ISubType_3 {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: InvoiceStatus;

  [key: string]: any;

  constructor(data?: ISubType_3) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  static fromJS(data: any): SubType_3 {
    data = typeof data === 'object' ? data : {};
    let result = new SubType_3();
    result.init(data);
    return result;
  }
...
export class InvoiceGDPRResponse extends Title_2 implements IInvoiceGDPRResponse {
  products!: ProductInstanceGDPRResponse[];
  files!: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  ...
  constructor(data?: IInvoiceGDPRResponse) {
    super(data);
    if (!data) {
      this.products = [];
      this.files = [];
  ...
  static override fromJS(data: any): InvoiceGDPRResponse {
    data = typeof data === 'object' ? data : {};
    let result = new InvoiceGDPRResponse();
    result.init(data);
    return result;
  }
...
export interface IInvoiceGDPRResponse extends ITitle_2 {
  products: ProductInstanceGDPRResponse[];
  files: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities: Activities3[];
  assignedToYou: boolean;
...
export class UserGDPRDumpResponse implements IUserGDPRDumpResponse {
  /** Function of this user, used when generating documents and printed below this user's name */
  function!: string;
  /** Email address of the user */
  email!: string;
  ...
  constructor(data?: IUserGDPRDumpResponse) {
    if (data) {
      for (var property in data) {
        if (data.hasOwnProperty(property)) (this as any)[property] = (data as any)[property];
      }
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['companies'])) {
        ...
        for (let item of _data['companies']) this.companies!.push(item);
      }
      if (Array.isArray(_data['products'])) {
        this.products = [] as any;
        for (let item of _data['products']) this.products!.push(item);
      }
    }
  }

  static fromJS(data: any): UserGDPRDumpResponse {
    data = typeof data === 'object' ? data : {};
    let result = new UserGDPRDumpResponse();
    result.init(data);
    return result;
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.companies)) {
      data['companies'] = [];
      for (let item of this.companies) data['companies'].push(item);
    }
    if (Array.isArray(this.products)) {
      data['products'] = [];
      for (let item of this.products) data['products'].push(item);
    }
    return data;
  }
}

export interface IUserGDPRDumpResponse {
  /** Function of this user, used when generating documents and printed below this user's name */
  function: string;
  /** Email address of the user */
  email: string;
...
export class GeneralPrivateInfo implements IGeneralPrivateInfo {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['financialYears'])) {
        ...
        for (let item of _data['financialYears']) this.financialYears!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.financialYears)) {
      data['financialYears'] = [];
      for (let item of this.financialYears) data['financialYears'].push(item);
    }
    return data;
  }
}
...
export class GeneralPublicInfo implements IGeneralPublicInfo {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.setupDone = _data['setupDone'];
    }
  }
...
export class ProductListResponse implements IProductListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(Product.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class ProductInstanceListResponse implements IProductInstanceListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(ProductInstance.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class InvoicedAmounts implements IInvoicedAmounts {
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data['delivered'] = this.delivered ? this.delivered.toJSON() : (undefined as any);
    data['notDelivered'] = this.notDelivered ? this.notDelivered.toJSON() : (undefined as any);
    return data;
  }
}
...
export class DashboardProductInstanceStats implements IDashboardProductInstanceStats {
  ...
  toJSON(data?: any) {
    data = typeof data === 'object' ? data : {};
    data['suggested'] = this.suggested ? this.suggested.toJSON() : (undefined as any);
    data['contracted'] = this.contracted ? this.contracted.toJSON() : (undefined as any);
    data['delivered'] = this.delivered ? this.delivered.toJSON() : (undefined as any);
    data['invoiced'] = this.invoiced ? this.invoiced.toJSON() : (undefined as any);
    data['paid'] = this.paid ? this.paid.toJSON() : (undefined as any);
    if (Array.isArray(this.financialYears)) {
      data['financialYears'] = [];
      for (let item of this.financialYears) data['financialYears'].push(item);
    }
...
export class CategoryListResponse implements ICategoryListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(ProductCategory.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class ProductsPerCategory implements IProductsPerCategory {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['amount'])) {
        this.amount = [] as any;
        for (let item of _data['amount']) this.amount!.push(item);
      }
      if (Array.isArray(_data['nrOfProducts'])) {
        this.nrOfProducts = [] as any;
        for (let item of _data['nrOfProducts']) this.nrOfProducts!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.amount)) {
      data['amount'] = [];
      for (let item of this.amount) data['amount'].push(item);
    }
    if (Array.isArray(this.nrOfProducts)) {
      data['nrOfProducts'] = [];
      for (let item of this.nrOfProducts) data['nrOfProducts'].push(item);
    }
    return data;
  }
}
...
export class ContractedProductsAnalysis implements IContractedProductsAnalysis {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['categories'])) {
        ...
        for (let item of _data['categories']) this.categories!.push(ProductsPerCategory.fromJS(item));
      }
      if (Array.isArray(_data['labels'])) {
        this.labels = [] as any;
        for (let item of _data['labels']) this.labels!.push(item);
      }
      if (Array.isArray(_data['financialYears'])) {
        this.financialYears = [] as any;
        for (let item of _data['financialYears']) this.financialYears!.push(item);
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.categories)) {
      data['categories'] = [];
      for (let item of this.categories) data['categories'].push(item ? item.toJSON() : (undefined as any));
    }
    if (Array.isArray(this.labels)) {
      data['labels'] = [];
      for (let item of this.labels) data['labels'].push(item);
    }
    if (Array.isArray(this.financialYears)) {
      data['financialYears'] = [];
      for (let item of this.financialYears) data['financialYears'].push(item);
...
export class InvoiceListResponse implements IInvoiceListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(Invoice.fromJS(item));
      }
      this.count = _data['count'];
...
export class InvoiceCreateParams implements IInvoiceCreateParams {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['productInstanceIds'])) {
        ...
        for (let item of _data['productInstanceIds']) this.productInstanceIds!.push(item);
      }
      this.companyId = _data['companyId'];
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.productInstanceIds)) {
      ...
      for (let item of this.productInstanceIds) data['productInstanceIds'].push(item);
    }
    data['companyId'] = this.companyId;
    return data;
  }
...
export class CustomInvoiceGenSettings implements ICustomInvoiceGenSettings {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['products'])) {
        this.products = [] as any;
        for (let item of _data['products']) this.products!.push(CustomProduct.fromJS(item));
      }
...
export class ContractListResponse implements IContractListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(Contract.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class ContactListResponse implements IContactListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(Contact.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class CompanyListResponse implements ICompanyListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(Company.fromJS(item));
      }
      this.count = _data['count'];
    }
  }
...
export class ETContract implements IETContract {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['products'])) {
        this.products = [] as any;
        for (let item of _data['products']) this.products!.push(ETProductInstance.fromJS(item));
      }
    }
  }
...
export class ETCompany implements IETCompany {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['contracts'])) {
        this.contracts = [] as any;
        for (let item of _data['contracts']) this.contracts!.push(ETContract.fromJS(item));
      }
    }
  }
...
export class ETCompanyListResponse implements IETCompanyListResponse {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['list'])) {
        this.list = [] as any;
        for (let item of _data['list']) this.list!.push(ETCompany.fromJS(item));
      }
      this.count = _data['count'];
  ...
  toJSON(data?: any) {
    ...
    data['count'] = this.count;
    data['extra'] = this.extra ? this.extra.toJSON() : (undefined as any);
    return data;
  }
}
...
export class Activities
  extends CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_
  implements IActivities
{
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ProductInstanceStatus;
  ...
  static override fromJS(data: any): Activities {
    data = typeof data === 'object' ? data : {};
...
export interface IActivities extends ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType: ProductInstanceStatus;
...
export class Activities2
  extends CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_
  implements IActivities2
{
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: ContractStatus;
  ...
  static override fromJS(data: any): Activities2 {
    data = typeof data === 'object' ? data : {};
    let result = new Activities2();
    result.init(data);
    return result;
  }
...
export interface IActivities2 extends ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType: ContractStatus;
...
export class Activities3
  extends CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_
  implements IActivities3
{
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType!: InvoiceStatus;
  ...
  static override fromJS(data: any): Activities3 {
    data = typeof data === 'object' ? data : {};
    let result = new Activities3();
    result.init(data);
    return result;
  }
...
export interface IActivities3 extends ICreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_ {
  /** Subtype of this activity, only used when the type = "STATUS" */
  subType: InvoiceStatus;
...
export class Companies extends Name_ implements ICompanies {
  invoices!: InvoiceGDPRResponse[];
  contracts!: ContractGDPRResponse[];
  files!: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities!: CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_[];
  ...
  override init(_data?: any) {
    ...
    if (_data) {
      ...
      if (Array.isArray(_data['invoices'])) {
        this.invoices = [] as any;
        for (let item of _data['invoices']) this.invoices!.push(InvoiceGDPRResponse.fromJS(item));
      }
      if (Array.isArray(_data['contracts'])) {
        this.contracts = [] as any;
        for (let item of _data['contracts']) this.contracts!.push(ContractGDPRResponse.fromJS(item));
      }
      if (Array.isArray(_data['files'])) {
        this.files = [] as any;
        for (let item of _data['files'])
      ...
      if (Array.isArray(_data['activities'])) {
        ...
        for (let item of _data['activities'])
          this.activities!.push(
            CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_.fromJS(item),
          );
      }
    }
  }

  static override fromJS(data: any): Companies {
    data = typeof data === 'object' ? data : {};
...
export interface ICompanies extends IName_ {
  invoices: InvoiceGDPRResponse[];
  contracts: ContractGDPRResponse[];
  files: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities: CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_[];
...
export class Products extends NameDutchOrNameEnglish_ implements IProducts {
  files!: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities!: CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_[];
  ...
  static override fromJS(data: any): Products {
    data = typeof data === 'object' ? data : {};
...
export interface IProducts extends INameDutchOrNameEnglish_ {
  files: CreatedAtOrUpdatedAtOrDeletedAtOrNameOrDownloadNameOrLocation_[];
  activities: CreatedAtOrUpdatedAtOrDeletedAtOrTypeOrDescriptionDutchOrDescriptionEnglish_[];
